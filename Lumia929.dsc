...
################################################################################
[Defines]
  PLATFORM_NAME                  = Lumia929
  PLATFORM_GUID                  = 566ba710-0bee-48e0-b56e-dcf4b0a38e04
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/Lumia929-$(ARCH)
  SUPPORTED_ARCHITECTURES        = ARM
  BUILD_TARGETS                  = DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = Lumia929Pkg/Lumia929.fdf
...
[PcdsFixedAtBuild.common]
  ...
  gLumia929PkgTokenSpaceGuid.PcdPreAllocatedMemorySize|0x7CD00000 #0FF00000
  gLumia929PkgTokenSpaceGuid.PcdUefiMemPoolSize|0x03300000

  # Default resolution for this firmware can be seen in dec file, override here for specific platform configuration if needed
  #gLumia929PkgTokenSpaceGuid.PcdMipiFrameBufferWidth|1080
  #gLumia929PkgTokenSpaceGuid.PcdMipiFrameBufferHeight|1920
  #gLumia929PkgTokenSpaceGuid.PcdMipiFrameBufferVisibleWidth|1080
  #gLumia929PkgTokenSpaceGuid.PcdMipiFrameBufferVisibleHeight|1920
...
!include Lumia929Pkg/Shared.dsc.inc
